...
class MenuView(
    ...
    // Undo menu items
    private val undoMenuItem: JMenuItem = JMenuItem("Undo")
    private val redoMenuItem: JMenuItem = JMenuItem("Redo")
    ...
    init {
        ...
        undoMenuItem.accelerator = KeyStroke.getKeyStroke(KeyEvent.VK_Z, ActionEvent.CTRL_MASK)
        redoMenuItem.accelerator = KeyStroke.getKeyStroke(KeyEvent.VK_Y, ActionEvent.CTRL_MASK)
